...
/**
 * OTA_VehCancelRQ — no TS twin in repo; follows same namespace/POS style as otaXmlBuilder.
 */
final class VehCancelRqBuilder
{
    public static function build(string $uniqueId, string $idContext, string $requestorId = '1000097'): string
    {
        ...
        $root = $xml->createElementNS('http://www.opentravel.org/OTA/2003/05', 'OTA_VehCancelRQ');
        ...
        $core = $xml->createElement('VehCancelRQCore');
