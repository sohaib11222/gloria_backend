...
echo $res->getBody();`,
    ...
    },
    {
        ...
        description: 'Canonical contract guide for standardizing List of Branches, Price Request, Booking Request, and Cancel/Reservation Status across mixed supplier XML implementations.',
        endpoints: [
            {
                ...
                description: 'Suppliers can expose location/branch inventory in their own format, but Gloria normalizes branch identity and location fields. Use this contract as the reference shape for UI/SDK integrations.',
                responses: [
                    {
                        status: 200,
...
console.log(res.data);`,
            ...
            },
            {
                ...
                method: 'POST',
                path: '/availability/submit',
                description: 'Price request is normalized into Gloria submit/poll semantics. Suppliers may send OTA XML or custom XML internally; Gloria maps into common JSON + gRPC fields.',
                body: [
                    { name: 'agreement_ref', required: true, type: 'string', description: 'Agreement reference' },
...
console.log(submit.data);`,
            ...
            },
            {
                ...
                method: 'POST',
                path: '/bookings',
                description: 'Booking request is standardized using Gloria booking fields while preserving OTA aliases. gRPC variable naming remains consistent with booking.proto.',
                body: [
                    { name: 'agreement_ref', required: true, type: 'string', description: 'Agreement reference' },
...
console.log(booking.data);`,
            ...
            },
            {
                ...
                method: 'POST',
                path: '/bookings/:ref/cancel',
                description: 'Cancel and reservation status are normalized for Gloria processing. Unknown or non-active agreement references are rejected with actionable messages.',
