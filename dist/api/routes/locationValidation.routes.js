...
import { validateLocationPayload } from "../../services/locationValidation.js";
 ...
 *                     type: string
 */
locationValidationRouter.post("/api/v1/location/validate", requireAuth(), async (req, res, next) => {
    try {
