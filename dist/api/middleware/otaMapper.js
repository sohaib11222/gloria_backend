...
const REVERSE_OTA_MAPPING = Object.fromEntries(Object.entries(OTA_FIELD_MAPPING).map(([internal, ota]) => [ota, internal]));
// Handle nested OTA structures (e.g., PickupLocation.LocationCode)
const OTA_NESTED_MAPPING = {
 ...
 */
function transformOtaToInternal(obj) {
    if (obj === null || obj === undefined) {
        return obj;
    }
    if (Array.isArray(obj)) {
    ...
    if (typeof obj === 'object' && obj.constructor === Object) {
        ...
        for (const [key, value] of Object.entries(obj)) {
            ...
            if (key === 'PickupLocation' && typeof value === 'object' && value !== null) {
                const locCode = value.LocationCode || value.locationCode;
                if (locCode) {
 ...
 */
export function otaMapper(req, res, next) {
